...
I did pre-select eight series for the users to select, such as Life expectancy, Current health expenditure per capita and Adjusted net national income,..ets.  
...
5. Learn how to use the Githip.
6. Connect the Githip to the R Gadget.
7. If I changed anything in R Gadget, I have to make sure to save that and do some steps to update all the changing in Githip as well.
